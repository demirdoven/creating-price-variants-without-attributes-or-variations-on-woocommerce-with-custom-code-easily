...
<img src="https://user-images.githubusercontent.com/24434119/117554406-1d4f0900-b060-11eb-8ed9-a4b4f4eb08ed.gif" width="800" height="auto">
...
<img src="https://user-images.githubusercontent.com/24434119/117555764-a4a17a00-b06a-11eb-8d7d-b3cc4720c452.png" width="600" height="auto">

And also I want users to be able to text their custom sizes.

<img src="https://user-images.githubusercontent.com/24434119/117554820-ae26e400-b062-11eb-921b-82f2079f1a24.png" width="600" height="auto">
...
#### Adding the calculator to the single product page ####
```
...
Note that you should add some conditions such as only spesific products/categories if you sell the other types of products. Otherwise this modification will be applied for all products' title.
```
...
In order to prevent users to add to cart a carpet product without choosing size and underlay, we should change the label and url of the button that shows on archive pages and the shop page.
```
...
#### Displaying custom values on cart and checkout pages ####
```
